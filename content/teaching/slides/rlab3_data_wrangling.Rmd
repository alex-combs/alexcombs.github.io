...
> **Type a lower-level hearing, "Filter"**
...
> **In a new code chunk, write code that will filter `gapminder` according to each prompt below and print the resulting table.**
...
> **Type a heading the same level as Filter titled, "Arrange"**
...
> **Copy & paste the code from the previous slide.**

> **Change the code so it prints a list of countries for 1952 instead of 2007.**
...
> **Start a new code chunk and name it kable. Copy&paste your code from the pipe code chunk above.**

> **Extend the code like so**

```{r, eval=FALSE}
  slice_head(n=5) %>% # Bottom line of previous code
  kable(digits = 1, #<<
