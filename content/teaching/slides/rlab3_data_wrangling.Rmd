...
- Don't worry about understanding the code. You can apply its logic for any dataset.
...
- Let's drop the last row of `ga_schdist_raw` along with the `state` variable since it is somewhat unnecessary
