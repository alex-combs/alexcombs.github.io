...
> **Inside your setup code chunk, try to load both `.RData` files into R.**

> **If it worked, click on the datasets in your environment pane to view the data.**

> **If .RData files do not play nicely, I will soon show code to import the original CSV and XLSX files.**
