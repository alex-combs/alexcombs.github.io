...
- Median and mode are not sensitive to extreme values
...
```{r}
(premie.table <- table(ncbirths$premie)) %>% 
  kable(col.names = c('Term', 'Count'))
```
...
- **Be careful using contingency tables to make conclusions. Do not generalize from a sample. Consider the numerator and denominator.**
