...
We take a sample of 1,000 college-educated women in Georgia and record the income of each.

--

- What is the unit of analysis in our dataset?
- What is (are) the necessary variable(s) in our dataset?
...
Suppose we want to know the percentage of Gwinnett County residents who have a valid ID for the next election.
...
We survey those entering the UGA Gwinnett Campus if they have a valid ID according to Georgia's election laws. We get 100 responses, and 80% said they have a valid ID.

--

- Is our result a parameter or an estimate?
...
- Do the units of analysis differ?

--

- Does this change what would be reported?
...
- An expensive new drug increases the median life expectancy among patients by one week. Insurance company decides not to cover what it deems an ineffective drug.
