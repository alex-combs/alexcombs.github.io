...
- We realized that it is not informative to compare counts of COVID cases and/or deaths across counties of different size populations
...
- The right skew makes bunches most counties within an interval that is difficult to distinguish.
...
> **Install the `scales` function in your console. Use the code below to display x axis in comma format.**
...
- Let's knit to see what how the export looks
...
> **Update the bar graph comparing the our 5 chosen counties using cases per 100,000**
