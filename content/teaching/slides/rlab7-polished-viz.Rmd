...
- Dividing population by 100,000. 
...
- Dividing cases and deaths by this new measure of population in 100,000s
...
covid_ga %>% 
  ...
  labs(title = 'Total County COVID Deaths',
       subtitle = 'March 20, 2022', x = 'Total Deaths') +
  theme_classic() +
  theme(axis.ticks.y = element_blank(),
        axis.line.y = element_blank(),
        axis.text.y = element_blank())
...
> **Update our first line graph to use cases per 100,000 people. Run the code.**
...
- Suppose we want the x axis to display every fourth month

> **Add the following to Viz 7. Be sure to include the `+` at the end.**
...
- Suppose we want to provide a visual marker for the beginning of UGA's Fall and Spring semesters during the pandemic.

> **Add the following to Viz 7. If typing manually, copy and paste once finished with the first `geom_vline`, then change the date.**
...
```{r, eval=FALSE, fig.width=9, fig.height=7}
  ...
  geom_vline(xintercept = date('2021-08-15'), 
             color = 'black', linetype = 'dashed') + 
  geom_vline(xintercept = date('2022-01-10'), 
             color = 'black', linetype = 'dashed') 
```
