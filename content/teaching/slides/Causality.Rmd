...
- Use **quasi-experimental** design that leverages some convenient context of the treatment allowing us to claim it is as good as randomized
...
- If you run a regression and the coefficient is statistically significant (we haven't covered significance yet), you have established correlation that is unlikely random
