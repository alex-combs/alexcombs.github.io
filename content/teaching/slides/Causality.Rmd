...
- Somewhat easy to establish when studying an event or intervention
  - Effect of Medicaid expansion on health outcomes
  
- More difficult when studying observed facts
  - Effect of exercise on Body Mass Index (BMI)
...
- Participant of a job training program gets a new job after completing the program
