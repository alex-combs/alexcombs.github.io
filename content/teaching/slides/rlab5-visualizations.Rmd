...
Which of the following graphs is effective at visualizing the values of a single categorical variable?
...
Which of the following graphs is effective at visualizing the values of a single continuous variable?
...
Which of the following graphs is effective at visualizing the relationship between values of two categorical variables?
...
Which of the following graphs is effective at visualizing the relationship between values of a continuous variable and a categorical variable?
...
Which of the following graphs is effective at visualizing the relationship between values of two continuous variable?
...
Which graph is generally not recommended?
...
> **Create another bar chart for the `sex` variable in the `nhanes` data. Make the bars different colors and display percentages rather than counts.**
