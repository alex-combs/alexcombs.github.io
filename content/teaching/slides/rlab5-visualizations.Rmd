...
```{r}
yesterday <- '2022-02-13'
```

- Now we can add `yesterday` to our code any time we want to filter conditional on the most recent data, and we only need to update `yesterday` to update any graph we make.
