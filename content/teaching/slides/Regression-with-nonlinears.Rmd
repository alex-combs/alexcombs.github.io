...
- On average, a life expectancy is predicted to increase 0.11% with each 1% increase in GDP per capita, all else equal.
...
- You can't compare models that use ln(y) to models that do not based on the goodness of fit values our results produce.

- Converting goodness of fit measures to be comparable is beyond scope of this course.

- Instead, use scatterplots and your best judgment to decide whether to log transform.

---
class: inverse, center, middle

# Let's practice interpreting regression models using logs