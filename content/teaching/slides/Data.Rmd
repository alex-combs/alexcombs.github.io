...
library(tidyverse)
library(knitr)
generic <- tibble(Variable_1 = c("Unit of Analysis", "Unit", "Unit"),
...
# Suppose we want to investigate homelessness in Athens-Clarke County (potential driving factors, demographics, performance metrics, etc.). We need to collect data.

---
class: inverse, middle, center

# Let's form some groups. I'll ask some groups to develop a list of variables we might want to collect if the unit of analysis is **years**. Other groups will develop a list of variables if the unit of analysis is **individuals**.
