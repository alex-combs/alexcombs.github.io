...
- **Unit of analysis**:  the subject/entity (person, place, or thing) generating the data

- Each row contains an observation of a member within the unit of analysis

--

- **Variable**:  a characteristic measured of the member within the unit of analysis
...
- A raw dataset we which to use in software like RStudio should contain one unit of analysis. For example, state totals should be separate from county totals.
...
# Suppose we want to study those who are unhoused in Athens-Clarke County (potential causes or correlates, demographics, performance metrics, etc.). We need to collect data.
...
# Which of your variables are qualitative and which are quantitative?
