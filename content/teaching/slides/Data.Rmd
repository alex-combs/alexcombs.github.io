...
- Suppose we are asked to describe the homeless population in Athens-Clarke County
...
# A **qualitative** or **categorical** variable is a variable that is naturally expressed in words with no inherent numerical value

---
class: inverse, middle, center

# A **quantitative** or **numerical** variable is a variable that has inherent numerical meaning
