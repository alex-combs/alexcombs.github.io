...
# With your group, develop a list of variables we might want to collect if the unit of analysis is **year**. Then develop another list of variables if the unit of analysis is **individuals**.
...
- Qualitative data does not necessarily imply qualitative analysis
