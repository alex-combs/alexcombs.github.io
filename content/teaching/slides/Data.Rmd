...
# Suppose we want to study those who are unhoused in Athens-Clarke County (potential causes or correlates, demographics, government performance metrics, etc.). We need to collect data.
