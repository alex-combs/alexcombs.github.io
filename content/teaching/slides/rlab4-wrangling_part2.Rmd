...
> **Move cursor to bottom of file and use "Run" menu to run all code chunks above**

> **Load one additional package**
...
- The `kable()` function, part of the `knitr` package, allows us to format tables.
