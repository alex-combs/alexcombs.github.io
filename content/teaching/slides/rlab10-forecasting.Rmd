...
- We can be more scientific than using our eyeballs to detect patterns
...
- Lag - term used to identify a past value
...
- Cannot improve the forecast in to a significant degree
...
- We can formally (i.e. hypothesis test) test for white noise like so:
  - Null is white noise
  - Alternative is there is white noise
...
4. Seasonal Naive - same as naive but predicts each season as equal its most recent season
...
- We prefer the model is the best fit
...
- Exponential smoothing is most common; include trends and seasonality as needed
