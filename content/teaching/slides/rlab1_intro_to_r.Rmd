...
- export your work to HTML, Word, and PDF
...
- Let's understand what the heck we're looking at
...
- Objects are anything you tell R to temporarily save during a session, which can also be permanently saved if you tell R to do so. The environment pane keeps a list of all objects. Think of objects as different sheets in an Excel file--each sheet can be anything you want. 
...
- If you prefer Word, use the above YAML every time
