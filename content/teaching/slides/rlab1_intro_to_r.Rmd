...
- First few weeks may involve frequent stopping as I help students 
...
- By default, an Rmd loads as a template. The template information is informative for beginners.
...
> **At the bottom of your Rmd, insert a code chunk and add some arbitrary arithmetic inside it.**

> **Click `Enter` a few times and type another line of arithmetic below the first**
...
> **Knit your Rmd again. (this should cause an intentional error)**
...
- If a code chunk in your document depends on something you did in the console, it won't knit unless we include that code
...
- But there is no code in our Rmd document that imports `states1`. When we knit, it is as if we do not have `states1` imported
...
> **To re-open your project, find the .Rproj file on your computers file manager and open it.** 
