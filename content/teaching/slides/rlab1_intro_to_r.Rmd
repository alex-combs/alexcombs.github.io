...
- We usually want a separate folder for each project/assignment that holds all relevant data and documents
...
- Creates a .Rproj file that, when opened, automatically sets your working directory to that folder
...
> **Now re-run `load('states1.RData')` command**
...
> **Close your script. You don't have to save it if you don't want.**
