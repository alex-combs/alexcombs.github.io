...
# Aren't required to force the slopes to be parallel? Could allow the effect of years employed differ between male and female professors?

---
# Interaction model implications

$$y = \beta_0 + \beta_1x + \beta_2d + \beta_3 xd + \epsilon$$
$$y = b_0 + b_1x + b_2d + b_3 xd$$
