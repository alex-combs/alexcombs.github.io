...
- Any number of explanatory variables could be categorical
  ...
  - Represents a sort of treatment variable
...
- What is the standard interpretation for the `Sex` coefficient? Recall that Sex=1 for Male and 0 for Female.
...
- $\beta_3$ tells us how the slopes compare
  - For Sex = 1 (male), the marginal effect of years on salary is $\beta_1+\beta_3$
...
- Probability is expressed units of percent. Remember that a unit change in percent probability is a **percentage point** change.
