...
- Use a categorical variable as an outcome variable

---
# Adding to our toolbox

- So far, we have covered simple and multiple regression using quantitative or numerical variables

.font120[$$y=\beta_0+\beta_1x_1+\beta_2x_2+\dots+\beta_kx_k+\epsilon$$]

- Any of the explanatory variables could be categorical

- The outcome couls be categorical
...
- What do we want to include and what directions to we expect?
...
- For each year of employment, salary increases $748, on average.
- Male professors earn an average of $9,072 more than female professors.

---
# Interpreting categorical results
...
- If Sex = 1 (male), then the marginal effect of years on salary is $\beta_1+\beta_3$

- $\beta_2$ still tells us how the intercepts compare
  - If Sex = 1 (male), intercept is $\beta_0+\beta_2$
...
$$\hat{Salary}=82069+1637*YrsEmp+20129*Sex + -932*YrsEmp*Sex$$
...
- Same ol' regression model with a two-level categorical variable for the response
...
- Reduces the probability of divorce by 18%

--

- What is the probability of a 27 year-old making 50,000 who has 0 children?
